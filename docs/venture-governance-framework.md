...
> **Author:** Aaron Neyer — February 15, 2026
>
> A companion to [Techne Institute & RegenHub: Structural Overview](techne-structural-overview.md)

*Original source: [GitHub Gist](https://gist.github.com/unforced/3cae9d6092e0a9db31302eaa72d0c215)*
...
- Individual equity is capped at 10%
- Equity is distributed from center outward, not concentrated at the top
- The cooperative sells equity to investors via SAFE agreements tied to the specific venture
- Ventures can eventually spin out — the cooperative maintains meaningful ownership
- Revenue from ventures flows back through the cooperative's revenue architecture

### Outer Ring: Ecosystem Ventures

These are ventures that connect with the RegenHub ecosystem but weren't born from the core team.

Key principles:
- RegenHub receives 1-10% equity in the venture, negotiated based on depth of engagement
- The commons feeds the venture: access to space, talent, learning programs, network
...
- Investors make SAFE agreements tied to specific ventures, not to RegenHub or Techne
- RegenHub holds the bank account and administers the funds
- The equity being sold is in the venture
- The cooperative is the seller

### Current Opportunity: Kevin & Jeremy's $100K

Proposed structure:
- Present two ventures as complementary investment opportunities:
  - **Learn Vibe Build** — Educational tooling and AI learning infrastructure
  - **Parachute** — Personal agent computer, voice-first extended mind technology
- These are two halves of a coherent thesis: AI educational tooling creates power users of AI tools; AI tools create demand for better educational tooling
- Kevin and Jeremy receive SAFE agreements with choice in allocation across the two ventures
- Money flows through RegenHub's bank account and funds space buildout and operations
- Investor obligation sits at the venture level, not at the cooperative or learning center level
...
- What is the right individual equity cap? 10% is proposed. Should it vary by venture?
...
*This document is a living draft meant to advance the conversation about how ventures relate to the cooperative. Comments and revisions welcome from all organizers.*
